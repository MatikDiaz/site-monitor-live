...
# Create GUI elements
tk.Label(root, text="Website URL:", font=("Arial", 12)).pack(anchor=tk.W)
tk.Entry(root, textvariable=website_url, font=("Arial", 12)).pack(fill=tk.X, padx=10)

tk.Button(root, text="Open Website", command=open_website, font=("Arial", 12)).pack(pady=10, fill=tk.X)

monitoring_button = tk.Button(root, text="Start Monitoring", command=toggle_monitoring, font=("Arial", 12))
monitoring_button.pack(pady=10, fill=tk.X)
